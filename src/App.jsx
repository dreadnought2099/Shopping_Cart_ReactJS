...
function App() {
  ...
  const [selectedTown, setSelectedTown] = useState(() => {
    const storedTown = localStorage.getItem("selectedTown");
    return storedTown ? storedTown : ""; // Initialize from local storage
  });
  ...
  useEffect(() => {
    // Store selected town in local storage whenever it changes
  ...
  function clearCart() {
    setCartItems([]);
    setSelectedTown(""); // Clear selected town as well
    localStorage.removeItem("selectedTown"); // Remove town from local storage
  }
